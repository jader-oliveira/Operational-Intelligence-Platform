...
Provide the reasoner capability as an independently deployable, observable, and policy-controlled service.

## Responsibilities

- Generate ranked root-cause hypotheses from evidence packages.
- Cite evidence for every material claim.
- Expose uncertainty and alternative causes.
- Request additional evidence through approved tools.
- Run challenge review before human presentation.
...
- Unsupported claims are rejected by post-processing.
